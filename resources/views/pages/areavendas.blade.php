...
<div class="amado-pro-catagory clearfix">
    ...
    <div class="container">
        ...
        @endif
        <div>
            <form class="form-group" method="GET" action="/areaVendas/pesquisa">
                <div class="row">
                    <div class="col col-6">
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{@$venda->compradorVenda->nome}}</td>
                        ...
                        <td> {{ \Carbon\Carbon::parse($venda->created_at)->format('d/m/Y H:m:s')}}</td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
